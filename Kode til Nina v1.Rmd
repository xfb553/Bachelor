...
Z2_tab1_100_25 <- Z_2(quan = 0.05, sigma2 = 1, mu = 0, T = 250, n = 100000, shift = 0, scale = scale(0.025, 100, "t"), df = 100, dfnull = 100, Norm = FALSE, type = "t")
Z2_tab1_100_5 <- Z_2(quan = 0.05, sigma2 = 1, mu = 0, T = 250, n = 100000, shift = 0, scale = scale(0.05, 100, "t"), df = 100, dfnull = 100, Norm = FALSE, type = "t")
Z2_tab1_100_10 <- Z_2(quan = 0.05, sigma2 = 1, mu = 0, T = 250, n = 100000, shift = 0, scale = scale(0.1, 100, "t"), df = 100, dfnull = 100, Norm = FALSE, type = "t")

Z2_tab1_5_25 <- Z_2(quan = 0.05, sigma2 = 1, mu = 0, T = 250, n = 100000, shift = 0, scale = scale(0.025, 5, "t"), df = 5, dfnull = 5, Norm = FALSE, type = "t")
Z2_tab1_5_5 <- Z_2(quan = 0.05, sigma2 = 1, mu = 0, T = 250, n = 100000, shift = 0, scale = scale(0.05, 5, "t"), df = 5, dfnull = 5, Norm = FALSE, type = "t")
Z2_tab1_5_10 <- Z_2(quan = 0.05, sigma2 = 1, mu = 0, T = 250, n = 100000, shift = 0, scale = scale(0.1, 5, "t"), df = 5, dfnull = 5, Norm = FALSE, type = "t")
...
Z3_tab1_100_25 <- Z_3(quan = 0.05, T = 250, n = 100000, shift = 0, scale = scale(0.025, 100, "t"), df = 100, dfnull = 100, Norm = FALSE)
Z3_tab1_100_5 <- Z_3(quan = 0.05, T = 250, n = 100000, shift = 0, scale = scale(0.05, 100, "t"), df = 100, dfnull = 100, Norm = FALSE)
Z3_tab1_100_10 <- Z_3(quan = 0.05, T = 250, n = 100000, shift = 0, scale = scale(0.1, 100, "t"), df = 100, dfnull = 100, Norm = FALSE)

Z3_tab1_5_25 <- Z_3(quan = 0.05, T = 250, n = 100000, shift = 0, scale = scale(0.025, 5, "t"), df = 5, dfnull = 5, Norm = FALSE)
Z3_tab1_5_5 <- Z_3(quan = 0.05, T = 250, n = 100000, shift = 0, scale = scale(0.05, 5, "t"), df = 5, dfnull = 5, Norm = FALSE)
Z3_tab1_5_10 <- Z_3(quan = 0.05, T = 250, n = 100000, shift = 0, scale = scale(0.1, 5, "t"), df = 5, dfnull = 5, Norm = FALSE)
...
VaR_tab1_100_25 <- VaR_backtest(sigma2 = 1, mu = 0, T = 250, n = 100000, shift = 0, scale = scale(0.025, 100, 't'), df = 100, dfnull = 100, Norm = FALSE, type = 't')
VaR_tab1_100_5 <- VaR_backtest(sigma2 = 1, mu = 0, T = 250, n = 100000, shift = 0, scale = scale(0.05, 100, 't'), df = 100, dfnull = 100, Norm = FALSE, type = 't')
VaR_tab1_100_10 <- VaR_backtest(sigma2 = 1, mu = 0, T = 250, n = 100000, shift = 0, scale = scale(0.1, 100, 't'), df = 100, dfnull = 100, Norm = FALSE, type = 't')

VaR_tab1_5_25 <- VaR_backtest(sigma2 = 1, mu = 0, T = 250, n = 100000, shift = 0, scale = scale(0.025, 5, 't'), df = 5, dfnull = 5, Norm = FALSE, type = 't')
VaR_tab1_5_5 <- VaR_backtest(sigma2 = 1, mu = 0, T = 250, n = 100000, shift = 0, scale = scale(0.05, 5, 't'), df = 5, dfnull = 5, Norm = FALSE, type = 't')
VaR_tab1_5_10 <- VaR_backtest(sigma2 = 1, mu = 0, T = 250, n = 100000, shift = 0, scale = scale(0.1, 5, 't'), df = 5, dfnull = 5, Norm = FALSE, type = 't')
...
ggplot(data_combined, aes(x = x, y = y, color = gamma)) +
  ...
  scale_color_manual(
    values = c("blue", "orange", "red", "darkred", "black"),
...
plot_cdfs(
  ...
  alternative_names = c("Alternative Hypothesis 1 (1-CDF)", "Alternative Hypothesis 2 (1-CDF)"),
...
for (df in new_nu) {
    ...
    ES_2.5pct <- ES(alpha, df = df, type = 't', Norm = FALSE)
    
    VaR_1pct <- VaR(alpha=beta, df = df, type = 't', Norm = FALSE)
    
    ES_2.5pct_n <- ES(alpha, df = df, type = 't', Norm = TRUE)
  
    VaR_1pct_n <- VaR(alpha=beta, df = df, type = 't', Norm = TRUE)
...
```{r}
#Z2 df 100:
Z2_tab2_100_100 <-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 100, dfnull = 100, Norm = FALSE, type = 't')
Z2_tab2_100_10<-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 10,  dfnull = 100, Norm = FALSE, type = 't')
Z2_tab2_100_5<-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 5,  dfnull = 100, Norm = FALSE, type = 't')
Z2_tab2_100_3<-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 3,   dfnull = 100, Norm = FALSE, type = 't')

#Z2 df 10:
Z2_tab2_10_10 <-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 10, dfnull = 10, Norm = FALSE, type = 't')
Z2_tab2_10_5 <-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 5,  dfnull = 10, Norm = FALSE, type = 't')
Z2_tab2_10_3 <-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 3,  dfnull = 10, Norm = FALSE, type = 't')


#Z3 df 100:
Z3_tab2_100_100 <-Z_3(quan = 0.05, T=250, n = 100000, df=100, dfnull = 100, shift = 0, scale = 1)
Z3_tab2_100_10<-Z_3(quan = 0.05, T=250, n = 100000, df=10,  dfnull = 100, shift = 0, scale = 1)
Z3_tab2_100_5<-Z_3(quan = 0.05, T=250, n = 100000, df=5,  dfnull = 100, shift = 0, scale = 1)
Z3_tab2_100_3 <-Z_3(quan = 0.05, T=250, n = 100000, df=3,   dfnull = 100, shift = 0, scale = 1)

#Z3 df 10:
Z3_tab2_10_10<-Z_3(quan = 0.05, T=250, n = 100000, df=10,  dfnull = 10, shift = 0, scale = 1)
Z3_tab2_10_5 <-Z_3(quan = 0.05, T=250, n = 100000, df=5,   dfnull = 10, shift = 0, scale = 1)
Z3_tab2_10_3 <-Z_3(quan = 0.05, T=250, n = 100000, df=3,   dfnull = 10, shift = 0, scale = 1)

#VaR df 100:
VaR_tab2_100_100 <-VaR_backtest( sigma2= 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 100, dfnull = 100, Norm = FALSE, type = 't')
VaR_tab2_100_10 <-VaR_backtest( sigma2= 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 10,  dfnull = 100, Norm = FALSE, type = 't')
VaR_tab2_100_5 <-VaR_backtest( sigma2= 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 5,  dfnull = 100, Norm = FALSE, type = 't')
VaR_tab2_100_3 <-VaR_backtest( sigma2= 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 3,   dfnull = 100, Norm = FALSE, type = 't')

#VaR df 10:
VaR_tab2_10_10 <-VaR_backtest(sigma2= 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 10, dfnull = 10, Norm = FALSE, type = 't')
VaR_tab2_10_5 <-VaR_backtest(sigma2= 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 5,  dfnull = 10, Norm = FALSE, type = 't')
VaR_tab2_10_3<-VaR_backtest(sigma2= 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 3,  dfnull = 10, Norm = FALSE, type = 't')
```
...
```{r}
# Df = 100
Z2_tab2_100_100_n <-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 100, dfnull = 100, Norm = TRUE, type = 't')
Z2_tab2_100_10_n<-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 10,  dfnull = 100, Norm = TRUE, type = 't')
Z2_tab2_100_5_n <-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 5, dfnull = 100, Norm = TRUE, type = 't')
Z2_tab2_100_3_n<-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 3,   dfnull = 100, Norm = TRUE, type = 't')
...
VaR_tab2_100_100_n <-VaR_backtest( sigma2 = 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 100, dfnull = 100, Norm = TRUE, type = 't')
VaR_tab2_100_10_n <-VaR_backtest( sigma2 = 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 10,  dfnull = 100, Norm = TRUE, type = 't')
VaR_tab2_100_5_n <-VaR_backtest( sigma2 = 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 5,  dfnull = 100, Norm = TRUE, type = 't')
VaR_tab2_100_3_n <-VaR_backtest( sigma2 = 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 3,   dfnull = 100, Norm = TRUE, type = 't')

# Df = 10
Z2_tab2_10_10_n <-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 10, dfnull = 10, Norm = TRUE, type = 't')
Z2_tab2_10_5_n <-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 5,  dfnull = 10, Norm = TRUE, type = 't')
Z2_tab2_10_3_n <-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 3,  dfnull = 10, Norm = TRUE, type = 't')
...
VaR_tab2_10_10_n <-VaR_backtest( sigma2= 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 10, dfnull = 10, Norm = TRUE, type = 't')
VaR_tab2_10_5_n <-VaR_backtest( sigma2= 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 5, dfnull = 10, Norm = TRUE, type = 't')
VaR_tab2_10_3_n <-VaR_backtest( sigma2= 1 , mu = 0, T = 250, n = 100000, shift = 0 , scale  = 1, df = 3, dfnull = 10, Norm = TRUE, type = 't')
...
plot_cdfs(
  ...
  pct_10 =NULL,
  alternative_names = c("Alternative Hypothesis 1 (1-CDF)", "Alternative Hypothesis 2 (1-CDF)"),
  plot_title = "Figure 6: VaR, df = 100"
)
```

Figur 7
```{r}
# Figur 1 for Z2 (df = 10)
plot_cdfs(
  ...
  alternative_names = c("Alternative Hypothesis 1 (1-CDF)", "Alternative Hypothesis 2 (1-CDF)"),
  plot_title = "Figure 6: Z2, df = 10",
  xlim=c(-5,1)
)

# Figur 6 for Z3 (df = 10)
plot_cdfs(
  ...
  alternative_names = c("Alternative Hypothesis 1 (1-CDF)", "Alternative Hypothesis 2 (1-CDF)"),
  plot_title = "Figure 6: Z3, df = 10",
  xlim=c(-2.5, 0.25)
)

# Figur 6 for VaR (df = 10)
plot_cdfs(
...
ggplot(data_normalized_t, aes(x = x, y = y, color = df)) +
  ...
  scale_color_manual(
    values = c("blue", "red", "orange", "darkred")
  )
...
plot_cdfs(
  ...
  pct_10 = NULL,
  alternative_names = c("Alternative Hypothesis 1 (1-CDF)", "Alternative Hypothesis 2 (1-CDF)"),
  plot_title = "Figure 9: Norm VaR, df = 100"
)
```

Figur 10
```{r}
# Figur 9 for Z2 (df = 10)
plot_cdfs(
...
for (df in new_nu) {
    ...
    ES_2.5pct_3 <- ES(alpha, df = df, shift=shift_value, type = 't', Norm = FALSE)
    VaR_1pct_3 <- VaR(alpha=beta, shift=shift_value, df = df, type = 't', Norm = FALSE)
    ES_2.5pct_n_3 <- ES(alpha, df = df, shift=shift_value_n, type = 't', Norm = TRUE)
    VaR_1pct_n_3 <- VaR(alpha=beta, shift=shift_value_n, df = df, type = 't', Norm =TRUE)
...
```{r}
#df=100
Z1_tab3_100_100_VaR<-Z_1(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=100, dfnull = 100), df = 100, dfnull = 100,Norm = FALSE, type = 't')
Z1_tab3_100_10_VaR <-Z_1(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=10, dfnull = 100), df = 10, dfnull = 100, Norm = FALSE,type = 't')
Z1_tab3_100_5_VaR <-Z_1(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=5, dfnull = 100), df = 5, dfnull = 100,Norm = FALSE, type = 't')
Z1_tab3_100_3_VaR<-Z_1(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=3, dfnull = 100), df = 3, dfnull = 100,Norm = FALSE, type = 't')

Z2_tab3_100_100_VaR <-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=100, dfnull = 100) , scale  = 1, df = 100, dfnull = 100, Norm = FALSE, type = 't')
Z2_tab3_100_10_VaR <-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=10, dfnull = 100) , scale  = 1, df = 10, dfnull = 100, Norm = FALSE, type = 't')
Z2_tab3_100_5_VaR <-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=5, dfnull = 100) , scale  = 1, df = 5, dfnull = 100, Norm = FALSE, type = 't')
Z2_tab3_100_3_VaR <-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=3, dfnull = 100) , scale  = 1, df = 3, dfnull = 100, Norm = FALSE, type = 't')

Z3_tab3_100_100_VaR <-Z_3(quan = 0.05, T=250, n = 100000, df=100, dfnull = 100, shift = shift(0.975, df=100, dfnull = 100), scale = 1, Norm = FALSE)
Z3_tab3_100_10_VaR <-Z_3(quan = 0.05, T=250, n = 100000, df=10, dfnull = 100, shift = shift(0.975, df=10, dfnull = 100), scale = 1, Norm = FALSE)
Z3_tab3_100_5_VaR <-Z_3(quan = 0.05, T=250, n = 100000, df=5, dfnull = 100, shift = shift(0.975, df=5, dfnull = 100), scale = 1, Norm = FALSE)
Z3_tab3_100_3_VaR <-Z_3(quan = 0.05, T=250, n = 100000, df=3, dfnull = 100, shift = shift(0.975, df=3, dfnull = 100), scale = 1, Norm = FALSE)

VaR_tab3_100_100_VaR <- VaR_backtest( sigma2 = 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=100, dfnull = 100) , scale  = 1, df = 100, dfnull = 100, Norm = FALSE, type = 't')
VaR_tab3_100_10_VaR <-VaR_backtest( sigma2 = 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=10, dfnull = 100) , scale  = 1, df = 10,  dfnull = 100, Norm = FALSE, type = 't')
VaR_tab3_100_5_VaR <-VaR_backtest( sigma2 = 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=5, dfnull = 100) , scale  = 1, df = 5,  dfnull = 100, Norm = FALSE, type = 't')
VaR_tab3_100_3_VaR <-VaR_backtest( sigma2 = 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=3, dfnull = 100) , scale  = 1, df = 3,   dfnull = 100, Norm = FALSE, type = 't')


#df = 10
Z1_tab3_10_10_VaR <-Z_1(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=10, dfnull = 10), df = 10, dfnull = 10, Norm = FALSE, type = 't')
Z1_tab3_10_5_VaR <- Z_1(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=5, dfnull = 10), df = 5, dfnull = 10, Norm = FALSE, type = 't')
Z1_tab3_10_3_VaR<-Z_1(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=3, dfnull = 10), df = 3, dfnull = 10,Norm = FALSE, type = 't')

Z2_tab3_10_10_VaR <-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=10, dfnull = 10) , scale  = 1, df = 10, dfnull = 10, Norm = FALSE, type = 't')
Z2_tab3_10_5_VaR <-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=5, dfnull = 10) , scale  = 1, df = 5, dfnull = 10, Norm = FALSE, type = 't')
Z2_tab3_10_3_VaR <-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=3, dfnull = 10) , scale  = 1, df = 3, dfnull = 10, Norm = FALSE, type = 't')

Z3_tab3_10_10_VaR <-Z_3(quan = 0.05, T=250, n = 100000, df=10, dfnull = 10, shift = shift(0.975, df=10, dfnull = 10), scale = 1, Norm = FALSE)
Z3_tab3_10_5_VaR <-Z_3(quan = 0.05, T=250, n = 100000, df=5, dfnull = 10, shift = shift(0.975, df=5, dfnull = 10), scale = 1, Norm = FALSE)
Z3_tab3_10_3_VaR <-Z_3(quan = 0.05, T=250, n = 100000, df=3, dfnull = 10, shift = shift(0.975, df=3, dfnull = 10), scale = 1, Norm = FALSE)

VaR_tab3_10_10_VaR <-VaR_backtest( sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=10, dfnull = 10) , scale  = 1, df = 10, dfnull = 10, Norm = FALSE, type = 't')
VaR_tab3_10_5_VaR <-VaR_backtest( sigma2= 1 , mu = 0, T = 250, n = 100000, shift =shift(0.975, df=5, dfnull = 10) , scale  = 1, df = 5, dfnull = 10, Norm = FALSE, type = 't')
VaR_tab3_10_3_VaR <-VaR_backtest( sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=3, dfnull = 10) , scale  = 1, df = 3, dfnull = 10, Norm = FALSE, type = 't')
```

Normalized t
```{r}
#df=100
Z1_tab3_100_100_VaR_n<-Z_1(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=100, dfnull = 100, Norm=TRUE), df = 100, dfnull = 100, Norm=TRUE, type = 't')
Z1_tab3_100_10_VaR_n <-Z_1(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=10, dfnull = 100, Norm=TRUE), df = 10, dfnull = 100,  Norm=TRUE,type = 't')
Z1_tab3_100_5_VaR_n <-Z_1(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=5, dfnull = 100, Norm=TRUE), df = 5, dfnull = 100,  Norm=TRUE,type = 't')
Z1_tab3_100_3_VaR_n<-Z_1(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=3, dfnull = 100, Norm=TRUE), df = 3, dfnull = 100,  Norm=TRUE,type = 't')

Z2_tab3_100_100_VaR_n <-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=100, dfnull = 100, Norm=TRUE) , scale  = 1, df = 100, dfnull = 100, Norm = TRUE, type = 't')
Z2_tab3_100_10_VaR_n <-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=10, dfnull = 100, Norm=TRUE) , scale  = 1, df = 10, dfnull = 100, Norm = TRUE, type = 't')
Z2_tab3_100_5_VaR_n <-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=5, dfnull = 100, Norm=TRUE) , scale  = 1, df = 5, dfnull = 100, Norm = TRUE, type = 't')
Z2_tab3_100_3_VaR_n <-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=3, dfnull = 100, Norm=TRUE) , scale  = 1, df = 3, dfnull = 100, Norm = TRUE, type = 't')

#Z_3:
Z3_tab3_100_100_VaR_n <-Z_3(quan = 0.05, T=250, n = 100000, df=100, dfnull = 100, shift = shift(0.975, df=100, dfnull = 100, Norm=TRUE), scale = 1, Norm = TRUE)
Z3_tab3_100_10_VaR_n <-Z_3(quan = 0.05, T=250, n = 100000, df=10, dfnull = 100, shift = shift(0.975, df=10, dfnull = 100, Norm=TRUE), scale = 1, Norm = TRUE)
Z3_tab3_100_5_VaR_n <-Z_3(quan = 0.05, T=250, n = 100000, df=5, dfnull = 100, shift = shift(0.975, df=5, dfnull = 100, Norm=TRUE), scale = 1, Norm = TRUE)
Z3_tab3_100_3_VaR_n <-Z_3(quan = 0.05, T=250, n = 100000, df=3, dfnull = 100, shift = shift(0.975, df=3, dfnull = 100, Norm=TRUE), scale = 1, Norm = TRUE)

VaR_tab3_100_100_VaR_n <-VaR_backtest( sigma2 = 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=100, dfnull = 100, Norm=TRUE) , scale  = 1, df = 100, dfnull = 100, Norm = TRUE, type = 't')
VaR_tab3_100_10_VaR_n <-VaR_backtest( sigma2 = 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=10, dfnull = 100, Norm=TRUE) , scale  = 1, df = 10,  dfnull = 100, Norm = TRUE, type = 't')
VaR_tab3_100_5_VaR_n <-VaR_backtest( sigma2 = 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=5, dfnull = 100, Norm=TRUE) , scale  = 1, df = 5,  dfnull = 100, Norm = TRUE, type = 't')
VaR_tab3_100_3_VaR_n <-VaR_backtest( sigma2 = 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=3, dfnull = 100, Norm=TRUE) , scale  = 1, df = 3,   dfnull = 100, Norm = TRUE, type = 't')

#df=10
Z1_tab3_10_10_VaR_n <-Z_1(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=10, dfnull = 10, Norm=TRUE), df = 10, dfnull = 10,  Norm=TRUE,type = 't')
Z1_tab3_10_5_VaR_n <-Z_1(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=5, dfnull = 10, Norm=TRUE), df = 5, dfnull = 10,  Norm=TRUE,type = 't')
Z1_tab3_10_3_VaR_n<-Z_1(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=3, dfnull = 10, Norm=TRUE), df = 3, dfnull = 10,  Norm=TRUE,type = 't')

Z2_tab3_10_10_VaR_n <-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=10, dfnull = 10, Norm=TRUE) , scale  = 1, df = 10, dfnull = 10, Norm = TRUE, type = 't')
Z2_tab3_10_5_VaR_n <-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=5, dfnull = 10, Norm=TRUE) , scale  = 1, df = 5, dfnull = 10, Norm = TRUE, type = 't')
Z2_tab3_10_3_VaR_n <-Z_2(quan = 0.05, sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=3, dfnull = 10, Norm=TRUE) , scale  = 1, df = 3, dfnull = 10, Norm = TRUE, type = 't')

Z3_tab3_10_10_VaR_n <-Z_3(quan = 0.05, T=250, n = 100000, df=10, dfnull = 10, shift = shift(0.975, df=10, dfnull = 10, Norm=TRUE), scale = 1, Norm = TRUE)
Z3_tab3_10_5_VaR_n <-Z_3(quan = 0.05, T=250, n = 100000, df=5, dfnull = 10, shift = shift(0.975, df=5, dfnull = 10, Norm=TRUE), scale = 1, Norm = TRUE)
Z3_tab3_10_3_VaR_n <-Z_3(quan = 0.05, T=250, n = 100000, df=3, dfnull = 10, shift = shift(0.975, df=3, dfnull = 10, Norm=TRUE), scale = 1, Norm = TRUE)

VaR_tab3_10_10_VaR_n <-VaR_backtest(sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=10, dfnull = 10, Norm=TRUE), scale  = 1, df = 10, dfnull = 10, type = 't', Norm = TRUE)
VaR_tab3_10_5_VaR_n <-VaR_backtest( sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=5, dfnull = 10, Norm=TRUE) , scale  = 1, df = 5, dfnull = 10, type = 't', Norm = TRUE)
VaR_tab3_10_3_VaR_n <-VaR_backtest( sigma2= 1 , mu = 0, T = 250, n = 100000, shift = shift(0.975, df=3, dfnull = 10, Norm=TRUE) , scale  = 1, df = 3, dfnull = 10, type = 't', Norm = TRUE)
```

Printer std-t tabel - VaR er lidt off for df=100
```{r}
names100 <- c("Powerdf10", "Powerdf3")
names10 <- c("Powerdf5", "Powerdf3")
...
Printer norm-t tabel - Denne er off for VaR og Z1
```{r}
...
df_values <- c(100, 10, 5, 3)
x_range <- c(-6, 6)
fixed_var <- -VaR(alpha = 0.975, sigma2 = 1, mu = 0, shift = 0, scale = 1, df = 100, type = "t", Norm = FALSE)
...
ggplot(data_t, aes(x = x, y = y, color = df)) +
  ...
  scale_color_manual(
    values = c("darkblue", "red", "darkgreen", "darkred")
  )
```
...
plot_cdfs(
  ...
  pct_10 = NULL,
  alternative_names = c("Alternative Hypothesis 1 (1-CDF)", "Alternative Hypothesis 2 (1-CDF)"),
  plot_title = "Figure 12: Norm VaR, df = 100"
)
```
...
Tabel 4 - denne behøver vi ikke iflg. Nina
